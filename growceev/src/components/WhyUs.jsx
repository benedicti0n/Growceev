...
function WhyUs() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center py-10">
      <h1 className="text-center text-7xl tracking-wide font-bold mt-20 pt-10">Why Us?</h1>
      <div className="w-[800px] h-[600px] flex justify-between items-center mt-20">
        ...
        <h2 className='font-bold flex justify-center items-center text-lg'>Growceev</h2>
          {table1.map((t1) => (
            <div key={t1.id}>
              {t1.content}
            </div>
        ...
        {/* Table 2 */}
        <div className="w-[45%] h-full flex flex-col space-y-8 items-start">
        <h2 className='font-bold text-lg flex justify-center items-center'>Other Agencies</h2>
          {table2.map((t2) => (
            <div key={t2.id}>
              {t2.content}
            </div>
