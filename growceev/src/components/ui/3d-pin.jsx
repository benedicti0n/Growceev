    ...
    (<Link
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 px-1 top-1/2  flex justify-start items-start  rounded-2xl  hover:shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-white border-[1.5px] border-slate-400 transition duration-700 overflow-hidden">
